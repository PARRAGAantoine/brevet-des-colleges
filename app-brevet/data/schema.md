...
```js
{
  ...
  type: "qcm" | "true_false" | "order" | "short_answer",
...
- Pour `short_answer`, `choices` est inutile. L'eleve ecrit la reponse et `acceptedAnswers` peut ajouter des variantes acceptees.
